...
2025 年的一项针对多智能体系统的大规模研究《[Why Do Multi-Agent LLM Systems Fail?](https://arxiv.org/abs/2503.13657)》分析了 1642 条执行轨迹，揭示了主流框架 41%-86.7% 的失败率。研究提出了 **MAST** 分类法，其中与角色设计直接相关的是 **FC1：系统设计问题**。
