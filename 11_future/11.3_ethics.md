...
graph LR
    ...
    style Damage fill:#f8d7da,stroke:#dc3545
```

图 11-1：智能体系统的责任归属链路 (Liability Chain in Agent Systems)
...
### 11.3.4 数据保护与 GDPR 合规

在欧盟，智能体处理个人数据必须遵守 GDPR：

**关键要求**：

1. **合法基础**：必须有处理数据的合法依据
2. **数据最小化**：只收集必要的数据
3. **透明性 (Transparency)**：告知用户数据如何被使用
4. **可解释性 (Explainability)**：对自动化决策能够说明理由
...
**下一节**: [迈向通用人工智能 (AGI)](11.4_agi_path.md)
