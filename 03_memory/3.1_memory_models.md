...
| 认知模型 | 对应工程组件 | 详细章节 |
|----------|--------------|----------|
| **短期记忆 (Working Memory)** | 上下文窗口, KV Cache | [3.2 短期记忆算法](3.2_short_term_memory.md) |
| **长期记忆 (Long-term Memory)** | 向量数据库, RAG | [3.3 向量数据库](3.3_vector_databases.md) <br> [3.4 RAG 进阶实践](3.4_rag_advanced.md) |
