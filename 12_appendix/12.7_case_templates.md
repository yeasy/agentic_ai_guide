...
*   **关键技术栈**：
    *   **模型选型**：(如：Claude 4.6 Sonnet, OpenAI o3-pro, DeepSeek-R1)
...
图 12-4：标准协作架构图模板 (Standard Collaboration Architecture Template)
...
1.  **模型版本**：检查 OpenAI/Anthropic/Google 是否发布了更强或更便宜的新模型（如 o3 -> o4, Claude 4.5 -> 4.7）。
