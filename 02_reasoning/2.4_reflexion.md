...
Reflexion (反思) 是一种让智能体从自身经验中学习并持续改进的机制。它模拟了人类"反思-总结-改进"的认知过程，是实现自主学习智能体的关键技术。

### 2.4.1 什么是 Reflexion

#### 核心思想

Reflexion 的本质是让智能体**在任务失败后进行自我反思，将失败经验转化为可复用的知识**。
...
Reflexion 赋予智能体从失败中学习的能力，是实现真正自主学习系统的重要一步。核心要点：
