...
> [!NOTE] 术语说明
> 在智能体 AI 领域，**Reflexion** 通常特指 Shinn 等人提出的"基于语言反馈的强化学习"框架 (Reflexion framework)，而通用英语单词 **Reflection** 指的是更广泛的"反思"认知能力。本书中我们主要探讨这种机制，因此沿用学术界常用的 Reflexion 一词，但也涵盖广泛的反思 (Reflection) 能力。
...
反思赋予智能体从失败中学习的能力，是实现真正自主学习系统的重要一步。核心要点：
