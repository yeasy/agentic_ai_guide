...
更具体地说，MCP 服务器让智能体访问外部系统、服务和平台，而 Skills 提供智能体有效使用这些连接所需的上下文，教智能体如何利用这些访问权限做事。
...
**经验法则**：MCP 指令覆盖如何正确使用服务器及其工具，Skills 指令覆盖如何在特定流程或多服务器工作流中使用它们。

> [!TIP]
> 关于 MCP 与 Skills 协同的详细案例（如财务分析、会议准备），请参见 [4.4 智能体技能](4.4_skills.md) 章节。
