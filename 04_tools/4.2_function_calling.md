...
### 4.2.1 打破次元壁：从聊天机器人 (Chatbot) 到智能体

ChatGPT 发布初期，最令人诟病的一点是“它不知道刚才发生的新闻”和“它不能帮我点外卖”。这是因为 LLM 是被封印在服务器显卡里的“缸中之脑”，它无法联网，也无法操作文件系统。

**工具使用 (Tool Use)**，或者在 OpenAI 体系中称为 **函数调用 (Function Calling)**，彻底打破了这堵墙。它赋予了智能体“手”和“脚”，使其能够执行 API 调用、运行代码、控制浏览器，从而真正地干涉物理和数字世界。
...
一个全能的智能体通常通过 **Toolkit** 的形式加载一组工具：
...
结构化输出通过**约束解码（Constrained Decoding）**保证输出 100% 符合 Schema：
...
[**Toolformer**](https://arxiv.org/abs/2302.04761) 的出现标志着智能体开始学会使用工具。通过精心设计的 Schema 和鲁棒的 Runtime，我们将 LLM 从聊天窗口解放出来，使其成为了能够操作万物的万能接口。工具使用能力的强弱，直接决定了智能体的落地价值。
