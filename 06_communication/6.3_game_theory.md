...
当智能体的数量从几个增加到几百个、几千个时，不再关注"个体"的角色，而是关注"群体"涌现出的智能。这被称为 **群体智能（Swarm Intelligence）**。
...
图 6-2：OpenAI Swarm 去中心化架构 (OpenAI Swarm Decentralized Architecture)
...
图 6-3：多智能体辩论验证机制 (Multi-Agent Debate Verification Mechanism)
