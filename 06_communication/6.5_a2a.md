...
如果说 MCP 是智能体与工具/数据源的"USB 接口"，那么 **智能体对智能体协议（A2A）** 就是智能体与智能体之间的"互联网协议"。这两个标准共同构成了智能体 AI 时代的基础设施层。
...
graph TD
    ...
    class HR,Sales,IT,Finance agent;
    class A2A system;
    class Feat1,Feat2,Feat3,Feat4 tool;
```
...
flowchart TB
    ...
    class C1,C2,C3,C4 user;
    class P1,P2,P3,P4 system;
