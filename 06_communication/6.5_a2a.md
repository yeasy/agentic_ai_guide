...
如果说 MCP 是 Agent 与工具/数据源的"USB 接口"，那么 **智能体对智能体协议（Agent-to-Agent Protocol, A2A）** 就是 Agent 与 Agent 之间的"互联网协议"。这两个标准共同构成了 Agentic AI 时代的基础设施层。
...
每个符合 A2A 协议的 Agent 必须发布一个 **智能体名片（Agent Card）**——描述自己身份和能力的 JSON 文档。
