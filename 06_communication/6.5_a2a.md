...
图 6-4：A2A 协议连接效应 (A2A Protocol Connectivity Effect)
...
图 6-5：A2A 协议技术架构 (A2A Protocol Technical Architecture)
...
图 6-6：A2A 任务生命周期状态机 (A2A Task Lifecycle State Machine)
...
图 6-7：跨系统入职流程时序图 (Cross-System Onboarding Sequence Diagram)
