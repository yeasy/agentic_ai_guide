...
在多智能体系统中，**通信协议（Communication Protocol）** 是系统的神经网络。它决定了智能体之间如何交换信息、协调行动，以及在冲突时如何达成共识。
...
图 6-1：共享黑板架构 (Shared Blackboard Architecture)
...
| 失败模式 | 发生率 | 描述 | 典型症状 |
|---------|--------|------|---------|
| **FM-2.1 对话重置** | 2.2% | 对话历史意外清空 | 智能体突然"忘记"之前的讨论 |
| **FM-2.2 未请求澄清** | 6.8% | 面对歧义时擅自假设 | 基于错误假设继续执行 |
| **FM-2.3 任务偏离** | 7.4% | 逐渐偏离原始目标 | 讨论越来越跑题 |
| **FM-2.4 信息隐瞒** | 0.85% | 关键信息未传递给队友 | 其他智能体缺少必要上下文 |
