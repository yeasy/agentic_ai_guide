...
**多智能体系统 (MAS)** 通过模拟人类团队的协作模式，让多个专注于不同领域的智能体共同解决问题。本节将通过实战案例，深入解析两大主流 MAS 框架：AutoGen 和 CrewAI。

### 8.4.1 AutoGen: 工程师的瑞士军刀

微软推出的 AutoGen 是目前最硬核的多体框架。它的核心特点是 **对话即计算** 和强大的 **代码执行能力**。
...
如果说 AutoGen 适合极客，那么 CrewAI 就适合产品经理。它更强调 **角色扮演** 和 **流程编排**。
