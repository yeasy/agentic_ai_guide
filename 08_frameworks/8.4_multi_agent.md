...
> **框架生态更新（2026）**：Microsoft 于 2025 年 10 月合并 AutoGen 与 Semantic Kernel，推出统一的 **Microsoft Agent Framework**（RC 版本于 2026 年 2 月发布，1.0 GA 于 2026 年 4 月 3 日发布）。原 AutoGen 开源项目已转入维护模式，仅接收安全补丁。AutoGen 的原创建者则在 2025 年 11 月基于社区治理模式推出 **AG2**，保留熟悉的 AutoGen 0.2 架构并持续迭代。
...
```python
# CrewAI 示例（v1.14.2, April 2026）：用"角色 + 任务流"构建市场调研团队
...
- 一类框架更偏”角色流程”（研究→写作→审阅→交付），典型如 CrewAI（v1.14.2, 2026 年 4 月）。
